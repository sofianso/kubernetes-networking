...
app.post('/signup', async(req, res) => {
    ...
    try {
        ...
        const hashedPW = await axios.get(
            // AUTH_ADDRESS_SERVICE_HOST is autogenerated by Kubernetes
            // You also need to add AUTH_ADDRESS_SERVICE_HOST to docker-composer.yaml
            `http://${process.env.AUTH_ADDRESS_SERVICE_HOST}/hashed-password/` + password
        );
